 ...
 *
 */
public class FailedOrderJson extends GenericMethods {
	public Map<String, String> testData = ReadTestData.getJsonData("TumiTestData", "FailedOrder");

	/*
	 * Verify whether the user is able to place an order with invalid credit card
	 * details
	 */
	@Test
