...
public class ProductDetails extends GenericMethods {
	...
	@Test(priority = 5, description = "TA-5, Verify Add to Cart," + " Verify Airline Carry on guide and "
			+ " Accordians/labels")
	...
	public void verifyAccordionFeatures() {
		...
		/*
		 * Verify Free Returns : verifying if click on Free Returns, displaying content
		 * or not
		 */
